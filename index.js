const submitHandler = (event) => {
  ...
  //populates a FormData object that can be used to access
  //all form values
...
//validate whether input in ratings field is a number
function validateNumber(value) {
  return !isNaN(value);
}
//validate whether input in ratings field is within 1 & 5 inclusive
function validateRange(value, min, max) {
  return value >= min && value <= max;
}

//validation for each input field in form using FormData
